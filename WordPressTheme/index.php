        ...
        <div class="fv__opening-images">
          <picture>
            <source media="(min-width: 768px)"
              srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/opening-pc01-left.jpg">
            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/opening01-top.jpg" alt="透き通った海を泳ぐウミガメの様子"
              class="fv__opening-image01 js-opening01">
          </picture>
          <picture>
            <source media="(min-width: 768px)"
              srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/opening-pc01-right.jpg">
            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/opening01-bottom.jpg"
              alt="透き通った海を泳ぐウミガメの様子" class="fv__opening-image02 js-opening02">
          </picture>
        </div>
      </div>
      <!-- アニメーション終了 -->
        ...
        <div class="fv__bg-slider swiper js-fv-swiper">
          <div class="fv__wrapper swiper-wrapper">
            <div class="swiper-slide">
              <picture>
                <source media="(min-width: 768px)"
                  srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv-pc01.jpg">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv01.jpg" alt="透き通った海を泳ぐウミガメの様子">
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source media="(min-width: 768px)"
                  srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv-pc02.jpg">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv02.jpg"
                  alt="海にダイビングした二人と漂うウミガメの様子">
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source media="(min-width: 768px)"
                  srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv-pc03.jpg">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv03.jpg" alt="会場から見た空、陸、海の様子">
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source media="(min-width: 768px)"
                  srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv-pc04.jpg">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/fv04.jpg" alt="白い砂浜と透き通った海のビーチの様子">
              </picture>
            </div>
              ...
              <div class="campaign-card">
                <div class="campaign-card__header">
                  <div class="campaign-card__img">
                    <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign01.jpg"
                ...
                <div class="campaign-card__header">
                  <div class="campaign-card__img">
                    <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/campaign03.jpg"
                      alt="暗い海中を漂うクラゲの様子" loading="lazy" decoding="async">
                  </div>
                </div>
                <div class="campaign-card__body">
                  <div class="campaign-card__title-block">
      ...
      <div class="about__content about-content">
        <div class="about-content__image-block">
          <div class="about-content__img01">
            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/about01.jpg" alt="青い空と木、屋根の上のシーサーの様子"
              loading="lazy" decoding="async">
          </div>
          <div class="about-content__img02">
            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/about02.jpg" alt="透き通った海にいる2匹の黄色い熱帯魚の様子"
              loading="lazy" decoding="async">
          </div>
        </div>
    ...
    <div class="information__inner inner">
      ...
      <div class="information__wrapper">
        <div class="information__img slide-color-box js-slide-color-box">
          <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/information01.jpg" alt="海中のイソギンチャクと熱帯魚の様子"
            loading="lazy" decoding="async">
        </div>
      ...
      <div class="blog__items blog-cards">
          ...
          <a href="#" class="blog-card__link">
            <div class="blog-card__header">
              <div class="blog-card__img">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog01.jpg" alt="海中にあるピンク色のサンゴの様子"
                  loading="lazy" decoding="async">
              </div>
            </div>
        ...
        <div class="blog-cards__item blog-card">
          <a href="#" class="blog-card__link">
            <div class="blog-card__header">
              <div class="blog-card__img">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog02.jpg"
                  alt="海中をこちらに向かって泳ぐウミガメの様子" loading="lazy" decoding="async">
              </div>
            </div>
            <div class="blog-card__body">
              <time class="blog-card__date" datetime="2023-11-17">2023.11/17</time>
            ...
            <div class="blog-card__header">
              <div class="blog-card__img">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/blog03.jpg"
                  alt="イソギンチャクの中にいるカクレクマノミの様子" loading="lazy" decoding="async">
              </div>
            </div>
            <div class="blog-card__body">
              <time class="blog-card__date" datetime="2023-11-17">2023.11/17</time>
      ...
      <div class="voice__items voice-cards">
        <div class="voice-cards__item voice-card">
          <div class="voice-card__header">
            ...
            <div class="voice-card__img slide-color-box js-slide-color-box">
              <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/voice01.jpg"
                alt="麦わら帽子をかぶった女性が笑顔でこちらを見ている様子" loading="lazy" decoding="async">
            </div>
          </div>
        ...
        <div class="voice-cards__item voice-card">
          <div class="voice-card__header">
            ...
            <div class="voice-card__img slide-color-box js-slide-color-box">
              <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/voice02.jpg" alt="こちらを向いて親指を立てている男性の様子"
                loading="lazy" decoding="async">
            </div>
          </div>
          <div class="voice-card__body">
    ...
    <div class="price__inner inner">
      ...
      <div class="price__wrapper">
        <div class="price__img slide-color-box js-slide-color-box">
          <picture>
            <source media="(min-width: 768px)"
              srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/price-pc.jpg">
            <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/price.jpg" alt="海中を漂うウミガメの様子"
              loading="lazy" decoding="async">
          </picture>
        </div>
