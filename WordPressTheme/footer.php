<!-- ページトップ -->
<div class="page-top js-paage-top js-page-top-color">
  <a href="#top">
  </a>
</div>

<footer class="footer <?php if (!is_404()) : ?>layout-footer<?php endif; ?>">
      ...
      <div class="nav-menu__columns">
              ...
              <li class="nav-menu__item">
                ...
                <ul class="nav-menu__detail-items">
                  <li class="nav-menu__detail-item">
                    <a href="<?php echo esc_url(home_url("campaign_category/fun-diving")) ?>" class="js-drawer-link">ファンダイビング</a>
                  </li>
                  <li class="nav-menu__detail-item">
                    <a href="<?php echo esc_url(home_url("campaign_category/license-course")) ?>" class="js-drawer-link">ライセンス講習</a>
                  </li>
                  <li class="nav-menu__detail-item">
                    <a href="<?php echo esc_url(home_url("campaign_category/trial-diving")) ?>" class="js-drawer-link">体験ダイビング</a>
                  </li>
                </ul>
              </li>
              <li class="nav-menu__item">
        ...
        <div class="nav-menu__column">
          ...
          <div class="nav-menu__block">
            <ul class="nav-menu__items">
              <li class="nav-menu__item">
                <a href="<?php echo esc_url(home_url("/privacy-policy")) ?>"><span>プライバシー</span><span>ポリシー</span></a>
              </li>
              <li class="nav-menu__item">
