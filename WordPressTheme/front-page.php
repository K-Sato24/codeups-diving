        ...
        <div class="fv__opening-bg js-opening-bg">
          ...
          <div class="fv__opening-images">
            <picture>
              ...
              <img src="<?php echo esc_url($fv_top['url']); ?>" alt="オープニングアニメーション" class="fv__opening-image01 js-opening01">
            </picture>
            <picture>
              <source media="(min-width: 768px)" srcset="<?php echo esc_url($fv_right['url']); ?>">
              <img src="<?php echo esc_url($fv_bottom['url']); ?>" alt="オープニングアニメーション" class="fv__opening-image02 js-opening02">
            </picture>
          </div>
        </div>
        <!-- アニメーション終了 -->
                  ...
                  <div class="campaign-card">
                    <div class="campaign-card__header">
                      <div class="campaign-card__img">
                        ...
                        <?php else : ?>
                          <img src="<?php echo esc_url(get_theme_file_uri("/assets/images/common/no-image.webp")); ?>" alt="NoImage画像" />
                        <?php endif; ?>
                      </div>
                    </div>
            ...
            <div class="voice-cards__item voice-card">
              ...
              <div class="voice-card__body">
                <p class="voice-card__text text">
                  <?php
                  // 'voice_3' カスタムフィールドの内容を取得
                  $voice_content = get_field('voice_3');

                  // 85文字に制限し、続きがある場合は'…'を追加して表示
                  echo wp_trim_words($voice_content, 169, '…');
                  ?>
                </p>
              </div>
            </div>
