            ...
            <div class="nav-menu__columns">
                ...
                <div class="nav-menu__block">
                  <ul class="nav-menu__items">
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/campaign")) ?>" class="js-drawer-link">キャンペーン</a>
                    ...
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/about-us")) ?>" class="js-drawer-link">私たちについて</a>
                    </li>
                  </ul>
                </div>
                <div class="nav-menu__column">
                  <ul class="nav-menu__items">
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/information")) ?>" class="js-drawer-link">ダイビング情報</a>
                      <ul class="nav-menu__detail-items">
                        <li class="nav-menu__detail-item">
                    ...
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/blog")) ?>" class="js-drawer-link">ブログ</a>
                    </li>
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/voice")) ?>" class="js-drawer-link">お客様の声</a>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="nav-menu__column">
                <div class="nav-menu__block">
                  <ul class="nav-menu__items">
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/price")) ?>" class="js-drawer-link">料金一覧</a>
                      <ul class="nav-menu__detail-items">
                        <li class="nav-menu__detail-item">
                        ...
                        <li class="nav-menu__item">
                          <a href="<?php echo esc_url(home_url("/faq")) ?>" class="js-drawer-link">よくある質問</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
                ...
                <div class="nav-menu__block">
                  <ul class="nav-menu__items">
                    ...
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/terms-of-service")) ?>" class="js-drawer-link">利用規約</a>
                    </li>
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/site-map")) ?>" class="js-drawer-link">サイトマップ</a>
                    </li>
                    <li class="nav-menu__item">
                      <a href="<?php echo esc_url(home_url("/contact")) ?>" class="js-drawer-link">お問い合わせ</a>
                    </li>
                  </ul>
                </div>
              </div>
