                  ...
                  <ul class="nav-menu__items">
                    <li class="nav-menu__item">
                      ...
                      <ul class="nav-menu__detail-items">
                        ...
                        <li class="nav-menu__detail-item">
                          <a href="#" class="js-drawer-link">貸切体験ダイビング</a>
                        </li>
                        <li class="nav-menu__detail-item">
            ...
            <div class="nav-menu__block">
              <ul class="nav-menu__items">
                <li class="nav-menu__item">
                  ...
                  <ul class="nav-menu__detail-items">
                    <li class="nav-menu__detail-item">
                      <a href="page-price.html?table=license_course">ライセンス講習</a>
                    </li>
                    <li class="nav-menu__detail-item">
                      <a href="page-price.html?table=trial_diving">体験ダイビング</a>
                    </li>
                    <li class="nav-menu__detail-item">
                      <a href="page-price.html?table=fun_diving">ファンダイビング</a>
                    </li>
                    <li class="nav-menu__detail-item">
                      <a href="page-price.html?table=special_diving">スペシャルダイビング</a>
                    </li>
                    <li class="nav-menu__item">
